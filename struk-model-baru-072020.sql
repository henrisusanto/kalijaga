...
SELECT
	...
	, '' AS 'KEB.DAERAH'
	, '' AS 'PPG'
	, (SELECT strukdetail.dibulatkan FROM strukdetail, jatahdesadetail WHERE strukdetail.jatahDesaDetail = jatahdesadetail.uuid AND strukdetail.struk = struk.uuid  AND jatahdesadetail.infaq = 'cb46fc88-c62a-11e9-94b3-af3d22f46108') 'CKM PONPES'
	, (SELECT strukdetail.dibulatkan FROM strukdetail, jatahdesadetail WHERE strukdetail.jatahDesaDetail = jatahdesadetail.uuid AND strukdetail.struk = struk.uuid  AND jatahdesadetail.infaq = 'cb46ffbc-c62a-11e9-94b3-af3d22f46108') 'KEB.DESA'
	, 0 AS 'AGHNIYA DESA'
	, (SELECT strukdetail.dibulatkan FROM strukdetail, jatahdesadetail WHERE strukdetail.jatahDesaDetail = jatahdesadetail.uuid AND strukdetail.struk = struk.uuid  AND jatahdesadetail.infaq = 'cb470318-c62a-11e9-94b3-af3d22f46108') 'KEB.KELOMPOK'
